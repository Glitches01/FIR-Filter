...
#########################################
set top_level FIR_core_N
source -verbose "../common_script/common.tcl"
read_verilog "../../RTL/FIR_core_N.v"
read_verilog "../../RTL/CMEM_N.v"
read_verilog "../../RTL/ALU_N.v"
read_verilog "../../RTL/IMEM_N.v"
#read_verilog "../../RTL/fir/RF1SHD.v"
#read_verilog "../../RTL/fir/ram.v"
read_verilog "../../RTL/FSM.v"
read_verilog "../../RTL/FIFO_N.v"
#read_verilog "../../RTL/fir/ram.v"
